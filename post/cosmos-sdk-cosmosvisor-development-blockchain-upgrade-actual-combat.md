...
9:06AM INF received proposal module=consensus proposal={"Type":32,"block_id":{"hash":"6D3284C9F45FCA211DFC9B7BC368DDE638BDF320FC42C48D1E5D0DABE12C770F","parts":{"hash":"16C3A4AD0CD8B9F05800F199ED2EC7F24B5CB29EAEB89C3E85D4B5FABE4FF193","total":1}},"height":30,"pol_round"
:-1,"round":0,"signature":"CL7/cRo5egyJ40bZrIbRH0Pp8D+dc/fYsINc2tSSGgdLnjSHVYocysiNc2CJ8H++0Y+gXMdPPaozCu336Uh4CQ==","timestamp":"2022-10-28T09:06:08.418559499Z"}
...
9:06AM ERR CONSENSUS FAILURE!!! err="UPGRADE \"v2.0.0\" NEEDED at height: 30: " module=consensus stack="goroutine 131 [running]:\nruntime/debug.Stack()\n\t/usr/local/go/src/runtime/debug/stack.go:24 +0x65\ngithub.com/tendermint/tendermint/consensus.(*State).receiveRouti
ne.func2()\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:727 +0x4c\npanic({0x20489c0, 0xc0042834a0})\n\t/usr/local/go/src/runtime/panic.go:884 +0x212\ngithub.com/cosmos/cosmos-sdk/x/upgrade.BeginBlocker({{0xc0011c3ff0, 0xd}, 0xc0014d94
d0, {0x3178228, 0xc00194c080}, {0x31a2350, 0xc0001393a0}, 0xc00194ae40, {0x316ebc0, 0xc000f1bdc0}, ...}, ...)\n\t/root/go/pkg/mod/github.com/cosmos/cosmos-sdk@v0.46.3/x/upgrade/abci.go:56 +0xf94\ngithub.com/cosmos/cosmos-sdk/x/upgrade.AppModule.BeginBlock(...)\n\t/root/
go/pkg/mod/github.com/cosmos/cosmos-sdk@v0.46.3/x/upgrade/module.go:134\ngithub.com/cosmos/cosmos-sdk/types/module.(*Manager).BeginBlock(_, {{0x31923d0, 0xc000056090}, {0x31a4440, 0xc003f0e580}, {{0xb, 0x0}, {0xc004bac43c, 0x4}, 0x1e, ...}, ...}, ...)\n\t/root/go/pkg/mo
d/github.com/cosmos/cosmos-sdk@v0.46.3/types/module/module.go:484 +0x398\nsimapp/app.(*App).BeginBlocker(_, {{0x31923d0, 0xc000056090}, {0x31a4440, 0xc003f0e580}, {{0xb, 0x0}, {0xc004bac43c, 0x4}, 0x1e, ...}, ...}, ...)\n\t/root/simapp/app/app.go:723 +0x7b\ngithub.com/c
osmos/cosmos-sdk/baseapp.(*BaseApp).BeginBlock(_, {{0xc003eef940, 0x20, 0x20}, {{0xb, 0x0}, {0xc004bac43c, 0x4}, 0x1e, {0x18a13b62, ...}, ...}, ...})\n\t/root/go/pkg/mod/github.com/cosmos/cosmos-sdk@v0.46.3/baseapp/abci.go:183 +0x843\ngithub.com/tendermint/tendermint/ab
ci/client.(*localClient).BeginBlockSync(_, {{0xc003eef940, 0x20, 0x20}, {{0xb, 0x0}, {0xc004bac43c, 0x4}, 0x1e, {0x18a13b62, ...}, ...}, ...})\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/abci/client/local_client.go:280 +0x118\ngithub.com/tendermint/ten
dermint/proxy.(*appConnConsensus).BeginBlockSync(_, {{0xc003eef940, 0x20, 0x20}, {{0xb, 0x0}, {0xc004bac43c, 0x4}, 0x1e, {0x18a13b62, ...}, ...}, ...})\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/proxy/app_conn.go:81 +0x55\ngithub.com/tendermint/tender
mint/state.execBlockOnProxyApp({0x3193940?, 0xc000e75980}, {0x319b9d0, 0xc00134d840}, 0xc00369ed20, {0x31a3650, 0xc0005624f8}, 0x1d?)\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/state/execution.go:307 +0x3dd\ngithub.com/tendermint/tendermint/state.(*Bl
ockExecutor).ApplyBlock(_, {{{0xb, 0x0}, {0xc0012c5030, 0x7}}, {0xc0012c5038, 0x4}, 0x1, 0x1d, {{0xc003b9e0a0, ...}, ...}, ...}, ...)\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/state/execution.go:140 +0x171\ngithub.com/tendermint/tendermint/consensus.
(*State).finalizeCommit(0xc0011d1180, 0x1e)\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:1659 +0xafd\ngithub.com/tendermint/tendermint/consensus.(*State).tryFinalizeCommit(0xc0011d1180, 0x1e)\n\t/root/go/pkg/mod/github.com/tendermint/
tendermint@v0.34.22/consensus/state.go:1568 +0x2ff\ngithub.com/tendermint/tendermint/consensus.(*State).enterCommit.func1()\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:1503 +0x94\ngithub.com/tendermint/tendermint/consensus.(*State).e
nterCommit(0xc0011d1180, 0x1e, 0x0)\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:1541 +0xccf\ngithub.com/tendermint/tendermint/consensus.(*State).addVote(0xc0011d1180, 0xc003576fa0, {0x0, 0x0})\n\t/root/go/pkg/mod/github.com/tendermin
t/tendermint@v0.34.22/consensus/state.go:2155 +0x18dc\ngithub.com/tendermint/tendermint/consensus.(*State).tryAddVote(0xc0011d1180, 0xc003576fa0, {0x0?, 0x47c866?})\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:1953 +0x2c\ngithub.com/t
endermint/tendermint/consensus.(*State).handleMsg(0xc0011d1180, {{0x3170320?, 0xc00054cdb0?}, {0x0?, 0x0?}})\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:856 +0x170\ngithub.com/tendermint/tendermint/consensus.(*State).receiveRoutine(0
xc0011d1180, 0x0)\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:783 +0x505\ncreated by github.com/tendermint/tendermint/consensus.(*State).OnStart\n\t/root/go/pkg/mod/github.com/tendermint/tendermint@v0.34.22/consensus/state.go:379 +0x
12d\n"
